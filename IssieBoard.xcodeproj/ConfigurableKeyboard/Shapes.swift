...
func drawBackspace(bounds: CGRect, color: UIColor) {
    ...
    //let factors = getFactors(CGSizeMake(72, 64), bounds)
    let xScalingFactor = CGFloat(0.65)//factors.xScalingFactor
    let yScalingFactor = CGFloat(0.65)//factors.yScalingFactor
...
func drawShift(bounds: CGRect, color: UIColor, withRect: Bool) {
    ...
    //// Bezier Drawing
    var bezierPath = UIBezierPath()
    bezierPath.moveToPoint(CGPointMake(28 * xScalingFactor, 48 * yScalingFactor))//28 * xScalingFactor, 18 * yScalingFactor
...
func drawGlobe(bounds: CGRect, color: UIColor) {
    let factors = getFactors(CGSizeMake(43, 43), bounds)
    let xScalingFactor = factors.xScalingFactor
    let yScalingFactor = factors.yScalingFactor
    let lineWidthScalingFactor = factors.lineWidthScalingFactor
    
    centerShape(CGSizeMake(43 * xScalingFactor, 43 * yScalingFactor), bounds)
